...
func addDataProject(w http.ResponseWriter, r *http.Request) {
	...
	_, err = connection.Conn.Exec(context.Background(), "insert into tb_project (title, description, image, author_id, start_date, end_date, technologies) values ($1, $2, 'image.png', $3, $4, $5, $6)", title, description, author, startDate, endDate, technologies)
